...
router.post('/', authToken_1.authenticateToken, [(0, express_validator_1.check)('name').notEmpty().withMessage('Name is required')], handleValidationErrors_1.HandleValidationErrors, category_controller_1.createCategory);
