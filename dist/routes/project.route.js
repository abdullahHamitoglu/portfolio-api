...
router.delete('/:id', authToken_1.authenticateToken, project_controller_1.deleteProject);
router.delete('/', authToken_1.authenticateToken, project_controller_1.deleteAllProjects);
